...
(cl:defclass <StiffPoint> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (isTorqueZ
    ...
    :initform cl:nil)
   (forceDirection
    :reader forceDirection
    :initarg :forceDirection
...
(cl:ensure-generic-function 'forceDirection-val :lambda-list '(m))
(cl:defmethod forceDirection-val ((m <StiffPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ee_cart_imped_msgs-msg:forceDirection-val is deprecated.  Use ee_cart_imped_msgs-msg:forceDirection instead.")
  (forceDirection m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <StiffPoint>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'forceDirection) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <StiffPoint>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'forceDirection) istream)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<StiffPoint>)))
  ...
  "423fb85e41b3884ef2f1450ad5d93618")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'StiffPoint)))
  "Returns md5sum for a message object of type 'StiffPoint"
  "423fb85e41b3884ef2f1450ad5d93618")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <StiffPoint>))
  (cl:+ 0
     ...
     1
     1
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'forceDirection))
     8
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <StiffPoint>))
  ...
  (cl:list 'StiffPoint
    ...
    (cl:cons ':forceDirection (forceDirection msg))
