...
(cl:defmethod actual_force-val ((m <EECartImpedFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ee_cart_imped_msgs-msg:actual_force-val is deprecated.  Use ee_cart_imped_msgs-msg:actual_force instead.")
  (actual_force m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EECartImpedFeedback>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'actual_force) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EECartImpedFeedback>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'actual_force) istream)
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EECartImpedFeedback>)))
  ...
  "c8fe5eef886eb1afda3ae24635a6fa28")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EECartImpedFeedback)))
  "Returns md5sum for a message object of type 'EECartImpedFeedback"
  "c8fe5eef886eb1afda3ae24635a6fa28")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <EECartImpedFeedback>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'actual_force))
     8
