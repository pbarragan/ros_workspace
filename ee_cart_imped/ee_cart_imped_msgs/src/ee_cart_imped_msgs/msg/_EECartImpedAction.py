...
class EECartImpedAction(genpy.Message):
  _md5sum = "45dcb843c9d6fcf22a742d509b64dac6"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_13d6B4d2i8d3I.pack(_x.action_result.result.desired.pose.position.x, _x.action_result.result.desired.pose.position.y, _x.action_result.result.desired.pose.position.z, _x.action_result.result.desired.pose.orientation.x, _x.action_result.result.desired.pose.orientation.y, _x.action_result.result.desired.pose.orientation.z, _x.action_result.result.desired.pose.orientation.w, _x.action_result.result.desired.wrench_or_stiffness.force.x, _x.action_result.result.desired.wrench_or_stiffness.force.y, _x.action_result.result.desired.wrench_or_stiffness.force.z, _x.action_result.result.desired.wrench_or_stiffness.torque.x, _x.action_result.result.desired.wrench_or_stiffness.torque.y, _x.action_result.result.desired.wrench_or_stiffness.torque.z, _x.action_result.result.desired.isForceX, _x.action_result.result.desired.isForceY, _x.action_result.result.desired.isForceZ, _x.action_result.result.desired.isTorqueX, _x.action_result.result.desired.isTorqueY, _x.action_result.result.desired.isTorqueZ, _x.action_result.result.desired.forceDirection.x, _x.action_result.result.desired.forceDirection.y, _x.action_result.result.desired.forceDirection.z, _x.action_result.result.desired.forceDirection.w, _x.action_result.result.desired.time_from_start.secs, _x.action_result.result.desired.time_from_start.nsecs, _x.action_result.result.actual_pose.position.x, _x.action_result.result.actual_pose.position.y, _x.action_result.result.actual_pose.position.z, _x.action_result.result.actual_pose.orientation.x, _x.action_result.result.actual_pose.orientation.y, _x.action_result.result.actual_pose.orientation.z, _x.action_result.result.actual_pose.orientation.w, _x.action_result.result.effort_sq_error, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_13d6B4d2i3I.pack(_x.action_feedback.feedback.initial_point.pose.position.x, _x.action_feedback.feedback.initial_point.pose.position.y, _x.action_feedback.feedback.initial_point.pose.position.z, _x.action_feedback.feedback.initial_point.pose.orientation.x, _x.action_feedback.feedback.initial_point.pose.orientation.y, _x.action_feedback.feedback.initial_point.pose.orientation.z, _x.action_feedback.feedback.initial_point.pose.orientation.w, _x.action_feedback.feedback.initial_point.wrench_or_stiffness.force.x, _x.action_feedback.feedback.initial_point.wrench_or_stiffness.force.y, _x.action_feedback.feedback.initial_point.wrench_or_stiffness.force.z, _x.action_feedback.feedback.initial_point.wrench_or_stiffness.torque.x, _x.action_feedback.feedback.initial_point.wrench_or_stiffness.torque.y, _x.action_feedback.feedback.initial_point.wrench_or_stiffness.torque.z, _x.action_feedback.feedback.initial_point.isForceX, _x.action_feedback.feedback.initial_point.isForceY, _x.action_feedback.feedback.initial_point.isForceZ, _x.action_feedback.feedback.initial_point.isTorqueX, _x.action_feedback.feedback.initial_point.isTorqueY, _x.action_feedback.feedback.initial_point.isTorqueZ, _x.action_feedback.feedback.initial_point.forceDirection.x, _x.action_feedback.feedback.initial_point.forceDirection.y, _x.action_feedback.feedback.initial_point.forceDirection.z, _x.action_feedback.feedback.initial_point.forceDirection.w, _x.action_feedback.feedback.initial_point.time_from_start.secs, _x.action_feedback.feedback.initial_point.time_from_start.nsecs, _x.action_feedback.feedback.desired.header.seq, _x.action_feedback.feedback.desired.header.stamp.secs, _x.action_feedback.feedback.desired.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_13d6B4d2i3I.pack(_x.action_feedback.feedback.desired.pose.position.x, _x.action_feedback.feedback.desired.pose.position.y, _x.action_feedback.feedback.desired.pose.position.z, _x.action_feedback.feedback.desired.pose.orientation.x, _x.action_feedback.feedback.desired.pose.orientation.y, _x.action_feedback.feedback.desired.pose.orientation.z, _x.action_feedback.feedback.desired.pose.orientation.w, _x.action_feedback.feedback.desired.wrench_or_stiffness.force.x, _x.action_feedback.feedback.desired.wrench_or_stiffness.force.y, _x.action_feedback.feedback.desired.wrench_or_stiffness.force.z, _x.action_feedback.feedback.desired.wrench_or_stiffness.torque.x, _x.action_feedback.feedback.desired.wrench_or_stiffness.torque.y, _x.action_feedback.feedback.desired.wrench_or_stiffness.torque.z, _x.action_feedback.feedback.desired.isForceX, _x.action_feedback.feedback.desired.isForceY, _x.action_feedback.feedback.desired.isForceZ, _x.action_feedback.feedback.desired.isTorqueX, _x.action_feedback.feedback.desired.isTorqueY, _x.action_feedback.feedback.desired.isTorqueZ, _x.action_feedback.feedback.desired.forceDirection.x, _x.action_feedback.feedback.desired.forceDirection.y, _x.action_feedback.feedback.desired.forceDirection.z, _x.action_feedback.feedback.desired.forceDirection.w, _x.action_feedback.feedback.desired.time_from_start.secs, _x.action_feedback.feedback.desired.time_from_start.nsecs, _x.action_feedback.feedback.actual_pose.header.seq, _x.action_feedback.feedback.actual_pose.header.stamp.secs, _x.action_feedback.feedback.actual_pose.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_13d6B4d2i7d.pack(_x.action_feedback.feedback.actual_pose.pose.position.x, _x.action_feedback.feedback.actual_pose.pose.position.y, _x.action_feedback.feedback.actual_pose.pose.position.z, _x.action_feedback.feedback.actual_pose.pose.orientation.x, _x.action_feedback.feedback.actual_pose.pose.orientation.y, _x.action_feedback.feedback.actual_pose.pose.orientation.z, _x.action_feedback.feedback.actual_pose.pose.orientation.w, _x.action_feedback.feedback.actual_pose.wrench_or_stiffness.force.x, _x.action_feedback.feedback.actual_pose.wrench_or_stiffness.force.y, _x.action_feedback.feedback.actual_pose.wrench_or_stiffness.force.z, _x.action_feedback.feedback.actual_pose.wrench_or_stiffness.torque.x, _x.action_feedback.feedback.actual_pose.wrench_or_stiffness.torque.y, _x.action_feedback.feedback.actual_pose.wrench_or_stiffness.torque.z, _x.action_feedback.feedback.actual_pose.isForceX, _x.action_feedback.feedback.actual_pose.isForceY, _x.action_feedback.feedback.actual_pose.isForceZ, _x.action_feedback.feedback.actual_pose.isTorqueX, _x.action_feedback.feedback.actual_pose.isTorqueY, _x.action_feedback.feedback.actual_pose.isTorqueZ, _x.action_feedback.feedback.actual_pose.forceDirection.x, _x.action_feedback.feedback.actual_pose.forceDirection.y, _x.action_feedback.feedback.actual_pose.forceDirection.z, _x.action_feedback.feedback.actual_pose.forceDirection.w, _x.action_feedback.feedback.actual_pose.time_from_start.secs, _x.action_feedback.feedback.actual_pose.time_from_start.nsecs, _x.action_feedback.feedback.actual_force.force.x, _x.action_feedback.feedback.actual_force.force.y, _x.action_feedback.feedback.actual_force.force.z, _x.action_feedback.feedback.actual_force.torque.x, _x.action_feedback.feedback.actual_force.torque.y, _x.action_feedback.feedback.actual_force.torque.z, _x.action_feedback.feedback.effort_sq_error))
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.action_goal.goal.trajectory:
        ...
        _x = val1
        buff.write(_struct_6B.pack(_x.isForceX, _x.isForceY, _x.isForceZ, _x.isTorqueX, _x.isTorqueY, _x.isTorqueZ))
        _v49 = val1.forceDirection
        _x = _v49
        buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        _v50 = val1.time_from_start
        _x = _v50
        buff.write(_struct_2i.pack(_x.secs, _x.nsecs))
      _x = self
      buff.write(_struct_3I.pack(_x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
...
_struct_13d6B4d2i8d3I = struct.Struct("<13d6B4d2i8d3I")
_struct_13d6B4d2i3I = struct.Struct("<13d6B4d2i3I")
_struct_13d6B4d2i7d = struct.Struct("<13d6B4d2i7d")
