...
(ee_cart_imped_msgs::EECartImpedGoal &goal, 
 ...
 double fdx, double fdy, double fdz, double fdw) {
  ...
  goal.trajectory[new_point].forceDirection.x = fdx;
  goal.trajectory[new_point].forceDirection.y = fdy;
  goal.trajectory[new_point].forceDirection.z = fdz;
  goal.trajectory[new_point].forceDirection.w = fdw;
