...
(cl:defclass <EECartImpedFeedback> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type (cl:vector ee_cart_imped_control-msg:StiffPoint)
   :initform (cl:make-array 0 :element-type 'ee_cart_imped_control-msg:StiffPoint :initial-element (cl:make-instance 'ee_cart_imped_control-msg:StiffPoint)))
   (initial_point
    :reader initial_point
    :initarg :initial_point
    :type ee_cart_imped_control-msg:StiffPoint
    :initform (cl:make-instance 'ee_cart_imped_control-msg:StiffPoint))
   (desired
    :reader desired
    :initarg :desired
    :type ee_cart_imped_control-msg:StiffPoint
...
(cl:defmethod cl:initialize-instance :after ((m <EECartImpedFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EECartImpedFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ee_cart_imped_control-msg:<EECartImpedFeedback> is deprecated: use ee_cart_imped_control-msg:EECartImpedFeedback instead.")))
...
(cl:defmethod initial_point-val ((m <EECartImpedFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ee_cart_imped_control-msg:initial_point-val is deprecated.  Use ee_cart_imped_control-msg:initial_point instead.")
  (initial_point m))

(cl:ensure-generic-function 'desired-val :lambda-list '(m))
(cl:defmethod desired-val ((m <EECartImpedFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ee_cart_imped_control-msg:desired-val is deprecated.  Use ee_cart_imped_control-msg:desired instead.")
  (desired m))

(cl:ensure-generic-function 'actual_pose-val :lambda-list '(m))
(cl:defmethod actual_pose-val ((m <EECartImpedFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ee_cart_imped_control-msg:actual_pose-val is deprecated.  Use ee_cart_imped_control-msg:actual_pose instead.")
  (actual_pose m))

(cl:ensure-generic-function 'effort_sq_error-val :lambda-list '(m))
(cl:defmethod effort_sq_error-val ((m <EECartImpedFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ee_cart_imped_control-msg:effort_sq_error-val is deprecated.  Use ee_cart_imped_control-msg:effort_sq_error instead.")
  (effort_sq_error m))
...
(cl:defmethod requested_joint_efforts-val ((m <EECartImpedFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ee_cart_imped_control-msg:requested_joint_efforts-val is deprecated.  Use ee_cart_imped_control-msg:requested_joint_efforts instead.")
...
(cl:defmethod actual_joint_efforts-val ((m <EECartImpedFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ee_cart_imped_control-msg:actual_joint_efforts-val is deprecated.  Use ee_cart_imped_control-msg:actual_joint_efforts instead.")
...
(cl:defmethod running_time-val ((m <EECartImpedFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ee_cart_imped_control-msg:running_time-val is deprecated.  Use ee_cart_imped_control-msg:running_time instead.")
  (running_time m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EECartImpedFeedback>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'goal)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ee_cart_imped_control-msg:StiffPoint))
