...
(cl:defmethod cl:initialize-instance :after ((m <StiffPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StiffPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ee_cart_imped_control-msg:<StiffPoint> is deprecated: use ee_cart_imped_control-msg:StiffPoint instead.")))
...
(cl:defmethod pose-val ((m <StiffPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ee_cart_imped_control-msg:pose-val is deprecated.  Use ee_cart_imped_control-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'wrench_or_stiffness-val :lambda-list '(m))
(cl:defmethod wrench_or_stiffness-val ((m <StiffPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ee_cart_imped_control-msg:wrench_or_stiffness-val is deprecated.  Use ee_cart_imped_control-msg:wrench_or_stiffness instead.")
  (wrench_or_stiffness m))

(cl:ensure-generic-function 'isForceX-val :lambda-list '(m))
(cl:defmethod isForceX-val ((m <StiffPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ee_cart_imped_control-msg:isForceX-val is deprecated.  Use ee_cart_imped_control-msg:isForceX instead.")
  (isForceX m))

(cl:ensure-generic-function 'isForceY-val :lambda-list '(m))
(cl:defmethod isForceY-val ((m <StiffPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ee_cart_imped_control-msg:isForceY-val is deprecated.  Use ee_cart_imped_control-msg:isForceY instead.")
  (isForceY m))

(cl:ensure-generic-function 'isForceZ-val :lambda-list '(m))
(cl:defmethod isForceZ-val ((m <StiffPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ee_cart_imped_control-msg:isForceZ-val is deprecated.  Use ee_cart_imped_control-msg:isForceZ instead.")
  (isForceZ m))

(cl:ensure-generic-function 'isTorqueX-val :lambda-list '(m))
(cl:defmethod isTorqueX-val ((m <StiffPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ee_cart_imped_control-msg:isTorqueX-val is deprecated.  Use ee_cart_imped_control-msg:isTorqueX instead.")
  (isTorqueX m))

(cl:ensure-generic-function 'isTorqueY-val :lambda-list '(m))
(cl:defmethod isTorqueY-val ((m <StiffPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ee_cart_imped_control-msg:isTorqueY-val is deprecated.  Use ee_cart_imped_control-msg:isTorqueY instead.")
  (isTorqueY m))

(cl:ensure-generic-function 'isTorqueZ-val :lambda-list '(m))
(cl:defmethod isTorqueZ-val ((m <StiffPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ee_cart_imped_control-msg:isTorqueZ-val is deprecated.  Use ee_cart_imped_control-msg:isTorqueZ instead.")
  (isTorqueZ m))

(cl:ensure-generic-function 'time_from_start-val :lambda-list '(m))
(cl:defmethod time_from_start-val ((m <StiffPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ee_cart_imped_control-msg:time_from_start-val is deprecated.  Use ee_cart_imped_control-msg:time_from_start instead.")
  (time_from_start m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<StiffPoint>)))
  ...
  (cl:format cl:nil "Header header~%geometry_msgs/Pose pose~%geometry_msgs/Wrench wrench_or_stiffness~%bool isForceX~%bool isForceY~%bool isForceZ~%bool isTorqueX~%bool isTorqueY~%bool isTorqueZ~%duration time_from_start~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of postion and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: geometry_msgs/Wrench~%# This represents force in free space, seperated into ~%# it's linear and angular parts.  ~%Vector3  force~%Vector3  torque~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'StiffPoint)))
  "Returns full string definition for message of type 'StiffPoint"
  (cl:format cl:nil "Header header~%geometry_msgs/Pose pose~%geometry_msgs/Wrench wrench_or_stiffness~%bool isForceX~%bool isForceY~%bool isForceZ~%bool isTorqueX~%bool isTorqueY~%bool isTorqueZ~%duration time_from_start~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of postion and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: geometry_msgs/Wrench~%# This represents force in free space, seperated into ~%# it's linear and angular parts.  ~%Vector3  force~%Vector3  torque~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
