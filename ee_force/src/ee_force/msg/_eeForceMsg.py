"""autogenerated by genpy from ee_force/eeForceMsg.msg. Do not edit."""
import sys
...
class eeForceMsg(genpy.Message):
  _md5sum = "de54ba17451137cbb1bc233fa1cbaeed"
  _type = "ee_force/eeForceMsg"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """float64[] data
float64[] jointAngles
"""
  __slots__ = ['data','jointAngles']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(eeForceMsg, self).__init__(*args, **kwds)
