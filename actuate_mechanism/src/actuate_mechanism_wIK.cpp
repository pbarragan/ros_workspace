...
std::vector<double> ActuateMechanismwIK::calculateSol(double x_position, double y_position, double currentTemp[]){
...
pr2_controllers_msgs::JointTrajectoryGoal ActuateMechanismwIK::createJointGoal(double x_position, double y_position, double current[]){
...
void ActuateMechanismwIK::ee_force_callback(ee_force::eeForceMsg msg){
  ...
  double yForce = msg.data[1];
  double current[7] = msg.jointAngles;
