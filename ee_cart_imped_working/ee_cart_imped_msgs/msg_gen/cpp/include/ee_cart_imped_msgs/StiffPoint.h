/* Auto-generated by genmsg_cpp for file /home/barragan/pr2_repo/ros_workspace/ee_cart_imped/ee_cart_imped_msgs/msg/StiffPoint.msg */
...
struct StiffPoint_ {
  ...
  typedef  ::geometry_msgs::Quaternion_<ContainerAllocator>  _forceDirection_type;
   ::geometry_msgs::Quaternion_<ContainerAllocator>  forceDirection;
...
struct MD5Sum< ::ee_cart_imped_msgs::StiffPoint_<ContainerAllocator> > {
  ...
  {
    return "423fb85e41b3884ef2f1450ad5d93618";
  }

  static const char* value(const  ::ee_cart_imped_msgs::StiffPoint_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x423fb85e41b3884eULL;
  static const uint64_t static_value2 = 0xf2f1450ad5d93618ULL;
};
...
s << std::endl;
    ...
    s << indent << "forceDirection: ";
s << std::endl;
    Printer< ::geometry_msgs::Quaternion_<ContainerAllocator> >::stream(s, indent + "  ", v.forceDirection);
