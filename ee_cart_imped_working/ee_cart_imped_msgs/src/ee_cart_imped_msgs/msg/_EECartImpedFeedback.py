...
class EECartImpedFeedback(genpy.Message):
  _md5sum = "c8fe5eef886eb1afda3ae24635a6fa28"
...
float64 z
"""
  __slots__ = ['header','goal','initial_point','desired','actual_pose','actual_force','effort_sq_error','requested_joint_efforts','actual_joint_efforts','running_time']
  _slot_types = ['std_msgs/Header','ee_cart_imped_msgs/StiffPoint[]','ee_cart_imped_msgs/StiffPoint','ee_cart_imped_msgs/StiffPoint','ee_cart_imped_msgs/StiffPoint','geometry_msgs/Wrench','float64','float64[]','float64[]','duration']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,goal,initial_point,desired,actual_pose,actual_force,effort_sq_error,requested_joint_efforts,actual_joint_efforts,running_time
