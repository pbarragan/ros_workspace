...
(ee_cart_imped_msgs::EECartImpedGoal &goal, 
 ...
 double ts, std::string frame_id) {
  ...
  goal.trajectory[new_point].forceDirection.x = 0;
  goal.trajectory[new_point].forceDirection.y = 0;
  goal.trajectory[new_point].forceDirection.z = 0;
  goal.trajectory[new_point].forceDirection.w = 1;
